...
/**
 * Activity for displaying hotels available for rating.
 * Implements the BookHotelView interface to interact with the ViewModel.
 */
public class ShowHotelsForRateActivity extends AppCompatActivity implements BookHotelView, BookHotelRecyclerViewAdaptor.HotelSelectionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_hotels_for_rate);
     ...
     * Shows a message and opens the RateHotelActivity with the selected hotel details.
     *
     * @param selectedHotel The hotel that was selected.
     */
    public void selectedHotel(Hotel selectedHotel) {
        Intent intent = new Intent(ShowHotelsForRateActivity.this, RateHotelActivity.class);
    ...
    /**
     * Shows the list of available hotels for rating.
    ...
    public void ShowHotels() {
        ...
        recyclerView.setAdapter(new BookHotelRecyclerViewAdaptor(this, viewModel.getPresenter().getHotelList(), this, R.layout.activity_show_hotels_for_rate_item));
    }
}
