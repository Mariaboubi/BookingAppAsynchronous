    ...
    private void filterHotel() {
        ...
        for (String optionStr : options) {
            ...
            if (filterOption == 3) {
                ...
                filteredHotels = filteredHotels.stream()
                        .filter(hotel -> hotel.getNoOfPeople().equalsIgnoreCase(numberOfperson.toString()))
                        .collect(Collectors.toList());
            }
            if (filterOption == 4) {
    ...
    public void rateHotel() {
        ...
        for (Hotel hotel : hotels) {
            ...
            if ((hotel.getHotelName()).equalsIgnoreCase(hotelName)) {
                ...
                int previousReviews = hotel.getNoOfReviews();
                ...
                hotel.setNoOfReviews(updatedReviews);
                foundHotel = true;
                break;
            }
        ...
        try {
            ...
            for (Object hotelObj : hotelsArray) {
                ...
                if (currentHotelName.equals(hotelName)) {
                    ...
                    hotel.put("noOfReviews", updatedReviews);
